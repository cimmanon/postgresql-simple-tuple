...
join2of3 :: (Eq a, Eq b, Eq c) =>
	[(a :. (b :. c))] -> [((a, b), [c])]
join2of3 xs = groupJoin $ map tuple2of3 xs
...
join2of4 :: (Eq a, Eq b, Eq c, Eq d) =>
	[(a :. (b :. (c :. d)))] -> [((a, b), [(c, d)])]
join2of4 xs = groupJoin $ map tuple2of4 xs

join3of4 :: (Eq a, Eq b, Eq c, Eq d) =>
	[(a :. (b :. (c :. d)))] -> [((a, b, c), [d])]
join3of4 xs = groupJoin $ map tuple3of4 xs
...
join2of5 :: (Eq a, Eq b, Eq c, Eq d, Eq e) =>
	[(a :. (b :. (c :. (d :. e))))] -> [((a, b), [(c, d, e)])]
join2of5 xs = groupJoin $ map tuple2of5 xs

join3of5 :: (Eq a, Eq b, Eq c, Eq d, Eq e) =>
	[(a :. (b :. (c :. (d :. e))))] -> [((a, b, c), [(d, e)])]
join3of5 xs = groupJoin $ map tuple3of5 xs

join4of5 :: (Eq a, Eq b, Eq c, Eq d, Eq e) =>
	[(a :. (b :. (c :. (d :. e))))] -> [((a, b, c, d), [e])]
join4of5 xs = groupJoin $ map tuple4of5 xs
...
join2of6 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f) =>
	[(a :. (b :. (c :. (d :. (e :. f)))))] -> [((a, b), [(c, d, e, f)])]
join2of6 xs = groupJoin $ map tuple2of6 xs

join3of6 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f) =>
	[(a :. (b :. (c :. (d :. (e :. f)))))] -> [((a, b, c), [(d, e, f)])]
join3of6 xs = groupJoin $ map tuple3of6 xs

join4of6 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f) =>
	[(a :. (b :. (c :. (d :. (e :. f)))))] -> [((a, b, c, d), [(e, f)])]
join4of6 xs = groupJoin $ map tuple4of6 xs

join5of6 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f) =>
	[(a :. (b :. (c :. (d :. (e :. f)))))] -> [((a, b, c, d, e), [f])]
join5of6 xs = groupJoin $ map tuple5of6 xs
...
join2of7 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f, Eq g) =>
	[(a :. (b :. (c :. (d :. (e :. (f :. g))))))] -> [((a, b), [(c, d, e, f, g)])]
join2of7 xs = groupJoin $ map tuple2of7 xs

join3of7 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f, Eq g) =>
	[(a :. (b :. (c :. (d :. (e :. (f :. g))))))] -> [((a, b, c), [(d, e, f, g)])]
join3of7 xs = groupJoin $ map tuple3of7 xs

join4of7 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f, Eq g) =>
	[(a :. (b :. (c :. (d :. (e :. (f :. g))))))] -> [((a, b, c, d), [(e, f, g)])]
join4of7 xs = groupJoin $ map tuple4of7 xs

join5of7 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f, Eq g) =>
	[(a :. (b :. (c :. (d :. (e :. (f :. g))))))] -> [((a, b, c, d, e), [(f, g)])]
join5of7 xs = groupJoin $ map tuple5of7 xs

join6of7 :: (Eq a, Eq b, Eq c, Eq d, Eq e, Eq f, Eq g) =>
	[(a :. (b :. (c :. (d :. (e :. (f :. g))))))] -> [((a, b, c, d, e, f), [g])]
join6of7 xs = groupJoin $ map tuple6of7 xs
